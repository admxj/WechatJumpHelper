# 微信跳一跳游戏助手
 ...
 [GitHub 项目地址](https://github.com/admxj/WechatJumpHelper)
...
* 自动识别图像计算距离
* 自动帮你点击屏幕
* 自动缓存图片，并在图片上标记一些识别结果，如下图![示例图片](Images/172_mark.png)
